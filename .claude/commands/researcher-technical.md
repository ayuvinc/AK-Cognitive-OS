...
Domain: technology stacks, APIs, tools, architecture patterns, implementation options
Trigger signals: technical architecture, stack selection, API evaluation, implementation patterns
